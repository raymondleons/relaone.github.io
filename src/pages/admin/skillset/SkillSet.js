...
import Sidebar from "../../../layouts/sidebar/SkillSetSidebar";
import { BrowserRouter as Router, Route, withRouter} from "react-router-dom";
import Navbar from '../../../layouts/navbar/SkillSetNavbar'
...
import {
  getSkillSet,
  delSkillSet } from '../../../redux/action/adminActions'
...
class User extends Component {
  ...
  render() {
    ...
    const displaySkillSet = skillsets.length ? (
      skillsets.map(({_id, name, username, email, address}, i) => {
        return(
          <tr>
            <td>{i +1}</td>
            <td key={_id}>{name}</td>
